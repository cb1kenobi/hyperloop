...
void CubeRenderer::Initialize(void *window)
{
	Direct3DBase::Initialize(reinterpret_cast<CoreWindow^>(window));
}
...
void CubeRenderer::CreateWindowSizeDependentResources()
{
	...
	auto perspective = XMMatrixPerspectiveFovRH(fovAngleY, aspectRatio, 0.01f, 100.0f);
	XMStoreFloat4x4(&m_constantBufferData.projection, XMMatrixTranspose(XMMatrixMultiply(perspective, XMLoadFloat4x4(&m_orientationTransform3D))));
}
