...
void ::life::App::InitializeComponent()
{
#if defined _DEBUG && !defined DISABLE_XAML_GENERATED_BREAK_ON_UNHANDLED_EXCEPTION
...
::Windows::UI::Xaml::Markup::IXamlType^ ::life::App::GetXamlType(Windows::UI::Xaml::Interop::TypeName type)
{
...
::Windows::UI::Xaml::Markup::IXamlType^ ::life::App::GetXamlType(::Platform::String^ fullName)
{
    if(_provider == nullptr)
    {
        _provider = ref new XamlTypeInfo::InfoProvider::XamlTypeInfoProvider();
...
::Platform::Array<Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::life::App::GetXmlnsDefinitions()
{
...
int main(::Platform::Array<::Platform::String^>^ args)
{
    ...
    Windows::UI::Xaml::Application::Start(ref new Windows::UI::Xaml::ApplicationInitializationCallback(
        [](Windows::UI::Xaml::ApplicationInitializationCallbackParams^ p) {
            ...
            auto app = ref new ::life::App();
        }));
}
#endif

void ::life::App::Connect(int connectionId, Platform::Object^ target)
{
