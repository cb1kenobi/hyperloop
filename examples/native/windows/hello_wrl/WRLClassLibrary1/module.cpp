...
extern "C" inline HRESULT WINAPI DllGetActivationFactory(_In_ HSTRING activatibleClassId, _Deref_out_ IActivationFactory** factory)
{
...
extern "C" inline HRESULT WINAPI DllGetClassObject(REFCLSID rclsid, REFIID riid, _Deref_out_ LPVOID *ppv)
{
    auto &module = Microsoft::WRL::Module<Microsoft::WRL::InProc>::GetModule();
