 ...
 */
var GlobalFunctions = ['require','parseInt','parseFloat','eval','setTimeout','setInterval','this','super','String','Number','__dirname','__filename'],
	GlobalObjects = ['Object','RegExp','Math','Date','Number','String','Array','Boolean','Function','Error','JSON','console','module','exports','super','this','globals'],
...
SourceFile.prototype.isGlobalClass = function(value) {
	return GlobalObjects.indexOf(value)!==-1 || (this.options.ticurrent && TitaniumObjects.indexOf(value)!==-1);
};
