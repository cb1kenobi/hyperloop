				...
				metabase.clang(
					...
					function(err, result) {
						...
						if (!options.colors && options.colors!==undefined) {
							log.info('Generating system metabase. This will take up to a minute (or greater) dependening on your environment.'.green.bold,'This file will be cached and will execute faster on subsequent builds.');
						}
						else {
							spinner.start(
								'Generating system metabase'.green.bold,
								'Generating system metabase will take up to a minute (or greater) dependening on your environment. This file will be cached and will execute faster on subsequent builds.');
						}
