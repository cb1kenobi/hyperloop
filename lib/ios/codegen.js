			...
			function executeWithClangAST(ast) {
				...
				var srcs = [],
			   	...
			   	try {
			   		...
			   		result = jsengine.generate(ast, codegenerate, depends[0]||'UIApplication', depends, generated, includes);
					...
					var types = path.join(options.srcdir,'types.m'),
						genCode = '/**\n'+
									...
									' * It was generated on '+new Date+'\n'+
									' */\n';

					// generate the imports/includes
					...
					fs.writeFileSync(types,genCode);
