/**
 * JavaScriptCore OO api implementation
 */
var fs = require('fs'),
    path = require('path'),
    ejs = require('ejs'),
...
function generate (config) {
    ...
    var metadata = config.metadata, 
        ...
        imports = ['#import <objc/runtime.h>','@import JavaScriptCore;'],
...
function generateCode (gen, genopts, callback) {
    ...
    gen.registerFunctionName = gen.generated.registerName;
...
function precompile(gen, callback) {
    return callback();
}
