 ...
 */
var GlobalObjects = ['Object','RegExp','Math','Date','Number','String','Array','Boolean','Function','Error','JSON','console','this','super','module','exports','globals'],
	GlobalFunctions = ['require','parseInt','parseFloat','eval','setTimeout','setInterval','this','super','String','Number'];
