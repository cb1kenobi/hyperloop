...
function generate (metadata, generation, interfaceName, depends, generated, imports, prefix, srchash) {
    ...
    return ejs.render(fs.readFileSync(path.join(__dirname,'templates','types.ejs')).toString(),{
        gen: {
            imports: imports,
            code: subcode + code,
            prefix: prefix
