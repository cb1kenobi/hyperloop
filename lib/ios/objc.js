...
if (module.id===".") {
	// console.log(generateInstanceInvocation('b','[A class]','foo',[],[],{type:'void',is_void:true}));
	// console.log('==============================================================================');
	// console.log(generateInstanceInvocation('b','[A class]','foo',[{type:'int'}],['a'],{type:'void',is_void:true}));
	// console.log('==============================================================================');
	console.log(generateInstanceInvocation('b','[A class]','foo',[{type:'int'}],['a'],{type:'int',is_void:false},'result'));
	// console.log('==============================================================================');

	// console.log(generateClassInvocation('b','[B class]','bar',[],[],{type:'void',is_void:true}));
	// console.log('==============================================================================');
	// console.log(generateClassInvocation('b','className','bar',[{type:'int'}],['a'],{type:'void',is_void:true}));
}
