...
var path = require('path'),
	...
	sdkConfigs = {
		'8.0': {
			...
			url: 'http://timobile.appcelerator.com.s3.amazonaws.com/jscore/JavaScriptCore-windows-%s.zip'
		},
		'8.1': {
			version: '1',
			checksum: '17a1d3c3215e3672ccba7f5496277ecc24dde221',
			url: 'http://dl.dropboxusercontent.com/u/16441391/temp/JavaScriptCore-windows-sdk8.1-v%s.zip'
		}
	},
	// TODO: Once #213 is taken care of, use this urlFormat again and delete the "url" keys above. https://github.com/appcelerator/hyperloop/issues/213
...
WinPackager.prototype.package = function(options, args, callback) {
	...
	// TODO: Once #213 is taken care of, use urlFormat, and include "options.sdk" in the format string again. https://github.com/appcelerator/hyperloop/issues/213
		url = require('util').format(sdkConfig.url, /*options.sdk, */version);
	...
	function runAppX() {
		programs.explorer('app:', function ran(err) {
