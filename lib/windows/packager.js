...
var Packager = require('../packager').Packager,
	...
	checksums = {
		...
		'8.1': '17a1d3c3215e3672ccba7f5496277ecc24dde221'
	},
	urls = {
		'8.0': 'http://timobile.appcelerator.com.s3.amazonaws.com/jscore/JavaScriptCore-windows-%s.zip',
		'8.1': 'http://dl.dropboxusercontent.com/u/16441391/temp/JavaScriptCore-windows-sdk8.1-v%s.zip'
	},
	// TODO: Once #213 is taken care of, use this urlFormat again and delete the "urls" variable above. https://github.com/appcelerator/hyperloop/issues/213
...
WinPackager.prototype.package = function(options, args, callback) {
	...
	// TODO: Once #213 is taken care of, use urlFormat, and include "options.sdk" in the format string again. https://github.com/appcelerator/hyperloop/issues/213
		url = require('util').format(urls[options.sdk], /*options.sdk, */version);
...
WinPackager.prototype.validate = function(options, args, requiredFn, proceed) {
	...
	if (!versions[options.sdk]) {
		log.fatal("Please specify a --sdk of " + Object.keys(versions).join(', ') + ".");
	}
